...
class NNModel(Model):
    ...
    def add_prediction_op(self):
        ...
        # conv3a_2 = tf.layers.conv2d(inception1, filters=256,kernel_size=[1,1],kernel_initializer=tf.contrib.layers.xavier_initializer(), padding="same",activation=tf.nn.relu)
        # conv3a_upscaled_2 = tf.image.resize_images(conv3a_2, [config.nx, config.nx])         

        # conv3b_2 = tf.layers.conv2d(inception1 ,filters=128,kernel_size=[1,1],kernel_initializer=tf.contrib.layers.xavier_initializer(), padding="same",activation=tf.nn.relu)
        # conv4b_2 = tf.layers.conv2d(conv3b_2 ,filters=256,kernel_size=[3,3],kernel_initializer=tf.contrib.layers.xavier_initializer(), padding="same",activation=tf.nn.relu)
        # conv4b_upscaled_2 = tf.image.resize_images(conv4b_2, [config.nx, config.nx])         

        # conv3c_2 = tf.layers.conv2d(inception1, filters=128,kernel_size=[1,1],kernel_initializer=tf.contrib.layers.xavier_initializer(), padding="same",activation=tf.nn.relu)
        # conv4c_2 = tf.layers.conv2d(conv3c_2 ,filters=192,kernel_size=[5,5],kernel_initializer=tf.contrib.layers.xavier_initializer(), padding="same",activation=tf.nn.relu)
        ...
        # pool3_conv1_2 = tf.layers.conv2d(pool3_2, filters=192,kernel_size=[1,1],kernel_initializer=tf.contrib.layers.xavier_initializer(), padding="same",activation=tf.nn.relu)
        ...
        pres = tf.layers.conv2d(inputs=inception2_conv2, filters=1,kernel_size=[1,1],kernel_initializer=tf.contrib.layers.xavier_initializer(), padding="same")
